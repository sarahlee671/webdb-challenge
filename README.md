...
RDBMS is a type of database that stand for relational database management system. It is the most common type of database management system. SQL is a structured query language. We use SQL to talk to RDBMS.

1. Why do tables need a `primary key`?

It is a way for us to access the rows in the table. Each row has a unique primary key that we can use to access it with.
...
We must have a third table that has a foreign key and it references the primary key on the other table.
